...
import { NonTerminal, TokenPro, Production, SymbolWrapper, SymbolTrait, NIL, Terminal, EOF, ParsingTable, Goto, Shift, Accept, Reduce, ILexer, IToken, ASTElement, SSymbol } from "@parser-generator/definition";
...
table.put(15,"else",new Reduce(p5));
table.put(15,"if",new Reduce(p5));
table.put(15,"Other",new Reduce(p5));
table.put(16,EOF,new Reduce(p4));
table.put(17,EOF,new Reduce(p3));
table.put(17,"else",new Reduce(p3));
table.put(18,Stmt,new Goto(19));
table.put(18,If,new Goto(9));
table.put(18,Other,new Goto(10));
table.put(18,"if",new Shift(11));
table.put(18,"Other",new Shift(12));
table.put(19,EOF,new Reduce(p4));
table.put(19,"else",new Reduce(p4));
let traits = new Map<SSymbol, SymbolTrait>();
traits.set(If,new SymbolTrait(-1,true));
